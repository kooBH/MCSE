...
## 2021-08-21
TARGET=UNET_t2
python src/inferenceUNET.py  -c config/UNET/${TARGET}.yaml -m /home/nas/user/kbh/MCSE_UNET/chkpt/${TARGET}/bestmodel.pt -o /home/nas/user/kbh/MCSE_UNET/output/${TARGET}_2 -d cpu
