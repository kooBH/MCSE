...
#TARGET=DCUNET_t15
#python ./src/trainerDCUNET.py -c ./config/${TARGET}.yaml -v ${TARGET} --device 'cuda:0'  -s 103700 --chkpt /home/nas/user/kbh/MCSE/chkpt/${TARGET}/bestmodel.pt

## 2021-05-07
TARGET=DCUNET_t15
python ./src/trainerDCUNET.py -c ./config/${TARGET}.yaml -v ${TARGET} --device 'cuda:0'  -s 127900 --chkpt /home/nas/user/kbh/MCSE/chkpt/${TARGET}/bestmodel.pt
